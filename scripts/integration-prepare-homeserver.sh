...
if [ -z $HOMESERVER ]; then
  echo "Please ensure HOMESERVER environment variable is set to the IP or hostname of the conciel."
  exit 1
fi
...
echo "Waiting for conciel to be available... (GET http://$HOMESERVER/_matrix/client/v3/login)"
