  ...
  void _handleCallState(CallState state) {
    ...
    switch (state) {
      case CallState.kConnecting:
        Logs().i('callkeep connecting');
        break;
      case CallState.kConnected:
        Logs().i('callkeep connected');
        if (!connected) {
      ...
      */
      ...
      case CallState.kRinging:
        callKeepManager.showCallkitIncoming(call);
        // TODO: Handle this case.
        break;
    }
  }
...
class CallKeepManager {
  ...
  String get appName => 'ConcielTalk';
  ...
  Map<String, dynamic> get alertOptions => <String, dynamic>{
        ...
        'foregroundService': {
          'channelId': 'chat.conciel.concieltalk',
          'channelName': 'Foreground service for Conciel Talk',
  ...
  Future<CallKeeper> displayIncomingCall(CallSession call) async {
    ...
    await _callKeep.displayIncomingCall(
      call.callId,
      '${call.room.getLocalizedDisplayname()} (Conciel)',
      localizedCallerName: '${call.room.getLocalizedDisplayname()} (Conciel)',
      handleType: 'number',
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                L10n.of(context)!.callingAccountDetails,
              ),
            ...
            ListTile(
              ...
              subtitle: Text(
                L10n.of(context)!.appearOnTopDetails,
              ),
            ...
            ListTile(
              ...
              title: Text(
                L10n.of(context)!.otherCallingPermissions,
              ),
  ...
  void openCallingAccountsPage(BuildContext context) async {
    ...
    await _callKeep.registerPhoneAccount();
    await _callKeep.registerAndroidEvents();
