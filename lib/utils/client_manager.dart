...
import 'package:concieltalk/utils/custom_http_client.dart';
import 'package:concieltalk/utils/custom_image_resizer.dart';
...
abstract class ClientManager {
  static const String clientNamespace = 'im.concieltalk.store.clients';
  ...
  static Client createClient(String clientName) {
    return Client(
      ...
      logLevel: kReleaseMode ? Level.error : Level.warning,
