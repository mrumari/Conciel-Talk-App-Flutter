...
class SettingsController extends State<Settings> {
  ...
  void setAvatarAction() async {
    ...
    profile!.avatarUrl = await matrix.client.getAvatarUrl(profile.userId);
    if (success.error == null) {
      updateProfile();
    }
  }
  ...
  void checkBootstrap() async {
    late bool crossSigning = false;
    late bool keycached = false;
    ...
    client.encryption?.crossSigning
        .isCached()
        .then((bool value) => crossSigning = value);
    client.encryption?.keyManager.isCached().then((value) => keycached = value);
    final needsBootstrap = keycached == false ||
  ...
  Widget build(BuildContext context) {
    final client = Matrix.of(context).client;
    profileFuture ??= client.fetchOwnProfile(
