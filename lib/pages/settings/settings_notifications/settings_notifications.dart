...
class SettingsNotificationsController extends State<SettingsNotifications> {
  ...
  void showBadge() {
    setState(() {
      AppConfig.showBadge = !AppConfig.showBadge;
      if (!AppConfig.showBadge) {
        AppConfig.showCount = false;
      } else {
        AppConfig.showCount = AppConfig.showCount;
      }
    });
  }

  void showCount() {
    setState(() => AppConfig.showCount = !AppConfig.showCount);
  }

  void showTile() {
    setState(() => AppConfig.showTile = !AppConfig.showTile);
  }
