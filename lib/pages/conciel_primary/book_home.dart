...
class BookHomePage extends StatefulWidget {
  final bool wcontext;
  const BookHomePage({Key? key, required this.wcontext}) : super(key: key);

  @override
  BookController createState() => BookController();
}

class BookController extends State<BookHomePage> with TickerProviderStateMixin {
  ...
  Color _innerRingColor = personalColorScheme.tertiary.withOpacity(0.5);
                            ...
                            child: _contextChange
                                ...
                                : ConcielArcText(
                                    ...
                                    text: ConcielTalkBase
                                        .instance!.callKeepBaseConfig.health,
                          ...
                          ArcButton(
                            ...
                            child: _contextChange
                                ...
                                : ConcielArcText(
                                    ...
                                    sweep: 120,
                                    text: ConcielTalkBase
                                        .instance!.callKeepBaseConfig.travel,
                                    color: personalColorScheme.outline,
                                    fontSize: 18,
                                  ),
                          ),
                          ...
                          ArcButton(
                            ...
                            child: _contextChange
                                ...
                                : ConcielArcText(
                                    ...
                                    sweep: 120,
                                    text: ConcielTalkBase
                                        .instance!.callKeepBaseConfig.sleep,
                                    color: personalColorScheme.outline,
                                    fontSize: 18,
                                  ),
                          ),
                                      ...
                                      onSelected: (SelectedSide opt) {
                                        ...
                                        switch (opt) {
                                          case SelectedSide.none:
                                            ...
                                            _cubeFaceSelect('none');
                                            return false;
                                          case SelectedSide.top: // RESTAURANTS
                                            _cubeFaceSelect('top');
                                            y = 0;
                                            x = 45;
                                            _contextChange
                                          ...
                                          case SelectedSide.left:
                                            ...
                                            !_contextChange
                                                ...
                                                : null;
                                            return true;
                                          case SelectedSide.right: // DELIVERY
                                            _ringWidgetKey.currentState
                                                ?.animateColors();
                                            ...
                                            _contextChange
                                                ...
                                                : null;
                                            return true;
                                          case SelectedSide.front: // GROCERIES
                                            _ringWidgetKey.currentState
                                                ?.animateColors();
