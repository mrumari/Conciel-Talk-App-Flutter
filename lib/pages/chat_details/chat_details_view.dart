...
import 'package:concieltalk/pages/chat_details/participant_list_item.dart';
...
import 'package:concieltalk/widgets/content_banner.dart';
...
class ChatDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final view = VRouter.of(context).queryParameters['view'];
